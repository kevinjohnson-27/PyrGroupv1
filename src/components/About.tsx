            ...
            <div className="relative z-10 border-[3px] border-black rounded-3xl p-14">
              ...
              <div className="mb-16">
                ...
                <p className="text-black text-lg font-extrabold leading-relaxed max-w-md">
                  To deliver high-quality academic and technical solutions with
                  innovation, consistency, and real-world impact.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-black text-lg font-extrabold leading-relaxed max-w-md">
                  To become a trusted digital innovation partner empowering
                  students and professionals with future-ready technology.
                </p>
              </div>
            </div>
          </div>
